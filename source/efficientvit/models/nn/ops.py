...
class MBConv(nn.Module):
    def __init__(
        ...
        # Added dropout to original paper
        self.dropout = nn.Dropout2d(dropout, inplace=False) if dropout > 0 else None
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Added dropout to original paper as in EfficientNet V2 (https://github.com/google/automl/blob/master/efficientnetv2/effnetv2_model.py)
        if self.dropout:
            x = self.dropout(x)
